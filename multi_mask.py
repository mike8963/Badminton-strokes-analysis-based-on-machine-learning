...
def maskVideo_multi(video_name,total_video_number = 1):
    
    points = np.array([[0,0],[0,800],[200,800],[400,300],[880,300],[1080,800],[1280,800],[1280,0]])
    black = (0,0,0) # black color
    

    for video_count in range(total_video_number):
        mask_video = video_name + "-" + video_count + "_masked.mp4"
...
if __name__ == "__main__":
    ...
    if(not sys.argv[1]):
        ...
        if(not sys.argv[2]):
            maskVideo_multi(video_name)
        else:
            maskVideo_multi(video_name,sys.argv[2])
